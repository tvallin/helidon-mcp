...
The examples require Java 27 or newer. The `calendar-application/calendar-microprofile` example is
excluded from the build because Helidon `27.0.0` does not include MicroProfile support.
